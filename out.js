...
module.exports = __webpack_require__.p + "d8eef247ab7a6e28d26f17594d049503.jpg";
...
var _Website = __webpack_require__(35);
...
var App = function App() {
    return _react2.default.createElement(_Website2.default, null);
};
...
module.exports = __webpack_require__.p + "a302f232751205e5bac7a953eb162e8d.png";
...
var _MyProfile = __webpack_require__(36);

var _MyProfile2 = _interopRequireDefault(_MyProfile);

var _MyItems = __webpack_require__(40);

var _MyItems2 = _interopRequireDefault(_MyItems);

var _RecentWork = __webpack_require__(41);
...
var Website = function (_Component) {
    ...
    _createClass(Website, [{
        ...
        value: function render() {
            var resultLanguage = void 0;
            resultLanguage = this.state.language == 'EN' ? _language2.default.en : _language2.default.pl;
            return _react2.default.createElement(
                'div',
                { className: 'main_container' },
                _react2.default.createElement(_MyProfile2.default, { fnLanguage: this.setLanguage, data: resultLanguage.profileDesc }),
                _react2.default.createElement(_MyItems2.default, { data: resultLanguage.myItems }),
                _react2.default.createElement(_RecentWork2.default, { dataRecent: resultLanguage.recentWork, dataElementRecent: resultLanguage.elementRecentWork }),
                _react2.default.createElement(_ContactForm2.default, { dataContact: resultLanguage.contactForm, dataAddress: resultLanguage.address }),
...
var _Language = __webpack_require__(37);

var _Language2 = _interopRequireDefault(_Language);

var _ProfilePhoto = __webpack_require__(38);

var _ProfilePhoto2 = _interopRequireDefault(_ProfilePhoto);

var _ProfileDesc = __webpack_require__(39);

var _ProfileDesc2 = _interopRequireDefault(_ProfileDesc);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_Language2.default, { fnLanguage: this.props.fnLanguage }),
                    _react2.default.createElement(_ProfilePhoto2.default, null),
                    _react2.default.createElement(_ProfileDesc2.default, { data: data })
                )
            );
        }
    }]);
...
var Language = function (_Component) {
    ...
    function Language() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Language.__proto__ || Object.getPrototypeOf(Language)).call.apply(_ref, [this].concat(args))), _this), _this.changeLanguage = function (e) {
            if (typeof _this.props.fnLanguage == 'function') {
                _this.props.fnLanguage(e.currentTarget.innerText);
                _this.setActiveForLanguage(e);
            }
        }, _this.setActiveForLanguage = function (e) {
    ...
    //set class active for language elements
    ...
    _createClass(ProfilePhoto, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement("div", { className: "photo_img" })
            );
        }
    }]);
...
var ProfileDesc = function (_Component) {
    _inherits(ProfileDesc, _Component);

    function ProfileDesc() {
        _classCallCheck(this, ProfileDesc);

        return _possibleConstructorReturn(this, (ProfileDesc.__proto__ || Object.getPrototypeOf(ProfileDesc)).apply(this, arguments));
    }

    _createClass(ProfileDesc, [{
        key: "render",
        value: function render() {
            var data = this.props.data;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "a",
                    { className: "desc_info_different" },
                    data[0]
                ),
                data[1],
                _react2.default.createElement(
                    "a",
                    { className: "desc_info_color" },
                    data[2]
                )
            );
        }
...
var MyItems = function (_Component) {
    _inherits(MyItems, _Component);

    function MyItems() {
        _classCallCheck(this, MyItems);

        return _possibleConstructorReturn(this, (MyItems.__proto__ || Object.getPrototypeOf(MyItems)).apply(this, arguments));
    }

    _createClass(MyItems, [{
        key: "render",
        value: function render() {
            var data = this.props.data;
...
var _ElementRecentWork = __webpack_require__(42);
...
var RecentWork = function (_Component) {
    _inherits(RecentWork, _Component);
...
var ElementRecentWork = function (_Component) {
    _inherits(ElementRecentWork, _Component);

    function ElementRecentWork() {
        _classCallCheck(this, ElementRecentWork);

        return _possibleConstructorReturn(this, (ElementRecentWork.__proto__ || Object.getPrototypeOf(ElementRecentWork)).apply(this, arguments));
    }

    _createClass(ElementRecentWork, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: "recent_work_element" },
                _react2.default.createElement(
                    "figure",
                    null,
                    _react2.default.createElement(
    ...
    return ElementRecentWork;
}(_react.Component);

exports.default = ElementRecentWork;
...
var ContactForm = function (_Component) {
    ...
    function ContactForm() {
        ...
        _this.setInputName = function (e) {
            _this.setState({
                inputName: e.target.value
            });
        };

        _this.setInputEmail = function (e) {
            _this.setState({
                inputEmail: e.target.value
            });
        };

        _this.setTextArea = function (e) {
            _this.setState({
        ...
        _this.handleSubmit = function (event) {
            //TODO:
            //add veryfication for form - actually set value in inputs are required
            event.preventDefault();
        };
        ...
        _this.state = {
            ...
            textInfo: 'Accumsan pellentesque commodo blandit enim arcu non at amet id arcu magna. Accumsan orci faucibus id eu lorem semper nunc nisi lorem vulputate lorem neque lorem ipsum dolor.',
            inputName: '', //for input,
            inputEmail: '', //for email 
            textAreaVal: '' //for text area
        };
        return _this;
    }
    //set val from input name

    //set val from input email

    //set val from textarea
    ...
    _createClass(ContactForm, [{
        ...
        value: function render() {
            var _state = this.state,
                inputName = _state.inputName,
                inputEmail = _state.inputEmail,
                textAreaVal = _state.textAreaVal;
            var _props = this.props,
                dataContact = _props.dataContact,
                dataAddress = _props.dataAddress;
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('textarea', {
                            ...
                            placeholder: dataContact[4],
                            required: 'required',
                            value: textAreaVal }),
                        _react2.default.createElement(
                            'button',
                            { type: 'submit', className: 'contact_btn' },
                            dataContact[5]
                        )
                    )
                ),
                _react2.default.createElement(_Address2.default, { data: dataAddress })
            );
        }
    }]);
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "li",
                                null,
                                _react2.default.createElement("i", { className: "fas fa-home address_icon" }),
                                data[0],
                                _react2.default.createElement(
                                    "i",
                            ...
                            _react2.default.createElement(
                                "li",
                                null,
                                _react2.default.createElement("i", { className: "fas fa-mobile-alt address_icon" }),
                                data[3]
                            ),
                            _react2.default.createElement(
                                "li",
                                null,
                                _react2.default.createElement("i", { className: "fas fa-envelope address_icon" }),
                                _react2.default.createElement(
                                    "a",
                                    { href: "mailto:wojte_kk@wp.pl" },
                                    data[4]
                                )
                            )
                        )
